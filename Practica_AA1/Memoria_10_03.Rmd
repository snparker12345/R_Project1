...
Definimos como factores en R las variables **gender, E_NEds, E_Bpag, weightIJ y **
...
**Como hemos podido observar, el único dato que parece poder resultar de interés es el año.**
...
*Se observa una concentración de últimas ediciones en el primer día del mes. Y que el día con menos cantidad es el 31, lo cual era de esperar.*
...
<!-- CORREGIR ESTO CUANDO TRAIN_PCA TENGA LAS VARIABLES DEFINITIVAS Y LAS COMPONENTES PRINCIPALES TAMBIÉN LO SEAN -->
...
*Aunque los datos se encuentran muy agrupados, podemos diferenciar 2 grupos. En el cúster 2 encontramos un dato marginado. Veremos más adelante técnicas con las que determinaremos si partir el cluster o no.*
...
*En este caso, lo más óptimo sería cortar a una altura de 20 aproximadamente, obteniéndose 3 clusters.*
...
<!-- Porque si k=2, aunque me forma 2 grupos, me hace los grupos tan abajo, cortando muchas más de 2 lineas,i.e segun interpreto, formando más de 2 grupos -->
