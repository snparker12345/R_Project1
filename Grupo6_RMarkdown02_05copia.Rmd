...
print(cf.rf2_test)
```
*En train se obtiene un valor de F1-Score de 0.49596 y en test de 0.32203. Este modelo ya no presenta el sobreajuste que presentaba el modelo anterior. El modelo anterior presentaba un valor de F1 en test de 0.36 aproximadamente, lo cual es superior que el obtenido con este modelo. También es cierto, que con este modelo esperamos generalizar mejor.*
...
## Predicción 2 con RF modificado.
