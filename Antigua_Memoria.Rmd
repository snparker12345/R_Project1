...
delete_kvecinos <- subset(test_Data, select=-c(gender,E_NEds, E_Bpag, firstDay, lastDay, NIJ,weightIJ,NActDays,NPages,ns_talk,ns_userTalk,ns_content,ns_user, ns_wikipedia,wikiprojWomen,pagesWomen,ano_inicial,mes_inicial,dia_inicial,ano_final,mes_final,dia_final))

df_kvecinos_test<- cbind(delete_kvecinos,new_NActDays, new_NPages,new_ns_talk, new_ns_userTalk, 
                  new_ns_content,new_ns_user,new_ns_wikipedia)
df_kvecinos_test <- as.data.frame(scale(df_kvecinos_test)) 
