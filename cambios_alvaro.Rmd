...
ALVARO MORAN.CÓDIGO EN GITHUB PARA LOS CONTRAFACTOS. MIRA ESTOS COMENTARIOS : 

Veamos qué variables se podrían cambiar para que una determinada predicción cambiase.

Por ejempplo, si una determinada observación tuviese menos ediciones -> se hibiese clasificado como mujer Si sus horas en trabajos wiki fuese mayor, p.e 30, a partir de esa valor se hubiera predicho mujer

Ver cuales con menos cambio consiguen predecir como queremos. Hacerlo para una observación.

Con el subset_to_valid() nos quedamos con los contrafactos validos.


poner semilla a lo que busca los contrafactos!!
