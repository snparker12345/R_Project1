...
#Eliminamos las variables que no podemos usar
delete_test <- subset(delete_cat, select=-c(gender,E_NEds, E_Bpag, firstDay, lastDay, 
                                           NIJ, weightIJ,NActDays,NPages,ns_talk,ns_userTalk,
                                           ns_content,ns_user, ns_wikipedia,wikiprojWomen,pagesWomen,ano_inicial,ano_final,mes_inicial,dia_inicial,dia_final,mes_final))

# Subconjunto de datos
test_cbind<- cbind(test_Data,new_NActDays, new_NPages,new_ns_talk, new_ns_userTalk, 
                  new_ns_content,new_ns_user,new_ns_wikipedia,NEds,NPcreated,NDays)

#Estandarizamos las variables
df_kvecinos_test <- scale(test_cbind)


#Estoy aplicandole los mismos cambios a test que le hicimos a train en el PCA pq creo que se usa el mismo conjunto para k vecinos 
