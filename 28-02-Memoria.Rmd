...
histogram_log=function(x_var){ # NO SE PORQUE SOFIA USA ESTA FUNCION PARA HACER EL HISTOGRAMA. MIRAR SI HAY ALGO DIFERENTE
...
weightIJ<-histogram(weightIJ, x_label='weightIJ'); weightIJ
