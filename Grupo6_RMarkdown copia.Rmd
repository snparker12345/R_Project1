...
*Realizamos el mismo método pero con valores de números de vecinos que van desde 1 hasta 30. En este caso obtenemos que el mejor número de vecinos es 10. Aun aumentando considerablemente las posibilidades de elección del modelo de 10 a 30, el modelo escoge un k=10, muy cercano al k=9 escogido anteriormente con Cross-Validation.*
