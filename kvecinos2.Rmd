...
*Graficamos las 4 variables con respecto al target.*
...
Primero tendremos que realizar al conjunto de test los mismos cambios que le hicimos a train.
```{r}
...
NEds_test<-test_Data$NEds
NPcreated_test<-test_Data$NPcreated
NDays_test<-test_Data$NDays
...
test_Data_kvecinos<- cbind(delete_cat,new_NActDays_test, new_NPages_test,new_ns_talk_test, new_ns_userTalk_test, 
                  new_ns_content_test,new_ns_user_test,new_ns_wikipedia_test,NEds_test,NPcreated_test,NDays_test)

test_Data_kvecinos_std <- scale(test_Data_kvecinos) 
```
