...
delete_PCA <- subset(train_Data, select=-c(gender,E_NEds, E_Bpag, firstDay, lastDay, NIJ,weightIJ,NActDays,NPages,ns_talk,ns_userTalk,ns_content,ns_user, ns_wikipedia))
...
<!-- VER COMO HACER QUE LA SALIDA SE QUEDE EN ******** SOLO ME INTERESAN LOS CENTROIDES OPTIMOS NO TODO LO DE DEBAJO DE LOS ASTERISCOS -->

Representemos la salida anterior.
```{r} 
#NO CONVERGE CONSULTAR ESTO
...
*Confirmamos que según NbClust existen 3 clústeres óptimos*
