...
F1 <- with(fit.knn$results, (2 * Precision * Recall) / (Precision + Recall))

best_k <- fit.knn$results$k[which.max(F1)]

# Mostrar el valor de k con el mayor resultado de F1
print(best_k)

fit.knn$bestTune<-best_k
```
