...
cf1 <- confusionMatrix(prediction1, as.factor(train_Data$gender))
print(cf1)
```
...
cf2 <- confusionMatrix(prediction2, as.factor(train_Data$gender))
print(cf2)
```
...
cf3 <- confusionMatrix(prediction3, as.factor(train_Data$gender))
print(cf3)
```
...
cf4 <- confusionMatrix(prediction4, as.factor(train_Data$gender))
print(cf4)
```
